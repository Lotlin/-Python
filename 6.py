...
list_user_word = (input('Введите слова через пробел и нажмите Enter '))
print(int_func(list_user_word))

# возможно, я что-то не поняла в задаче, слишком легко оказалось...
